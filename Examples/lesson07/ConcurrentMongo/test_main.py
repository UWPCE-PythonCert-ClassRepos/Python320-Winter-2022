...
from data_for_tests import SAMPLE_USERS_DATA, SAMPLE_STATUS_DATA
...
class TestSocialNetwork(unittest.TestCase):
    """
    tests for the Social Network User functions
    """
    ...
    def setUp(self):
        ...
        self.full_social_network = SocialNetwork(self.db_name)
    ...
    def test_init_social_network(self):
        ...
        """
        uc = main.init_social_network(self.db_name)
    ...
    def test_add_status_user_not_there(self):
        """
        add a status to an existing user
        """
        snw = self.full_social_network
        ...
        uid = 'aabbccdd'
        status_text = "just some text"
        result = main.add_status(user_id=uid,
                                 status_id='yyyyyy',
                                 status_text=status_text,
                                 status_collection=snw)
...
class TestSocialNetworkEmpty(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = start_mongo()
        self.client.drop_database(self.db_name)
        self.empty_social_network = SocialNetwork(self.db_name)
