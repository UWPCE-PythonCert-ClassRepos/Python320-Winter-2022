...
def init_collections(dataset):
    ...
    user_collection = main.init_user_collection(dataset)
    status_collection = main.init_status_collection(dataset)
...
if __name__ == '__main__':  # pragma: no cover
    ...
    if clear:
        ...
        print("Starting with existing db: 'social_network.db'")
    init_collections(socialnetwork_model.get_dataset('social.db', clear))
    mainloop()
